...
# Will download chromosome 10 of specific version GRCh36 of Homo sapiens genome
...
# Confirmation with Chromosome 8
cd ../data/genomes/
wget http://ftp.ensembl.org/pub/release-54/fasta/homo_sapiens/dna/Homo_sapiens.NCBI36.54.dna.chromosome.8.fa.gz
gunzip < Homo_sapiens.NCBI36.54.dna.chromosome.8.fa.gz > hsap_36sample_genomes.fna
rm Homo_sapiens.NCBI36.54.dna.chromosome.8.fa.gz

# Will also download the Recombination rate from HapMap release 22 (obtained using GRCh36)
cd ../../tools/RRC/hsap/
wget ftp://ftp.ncbi.nlm.nih.gov/hapmap/recombination/latest/rates/genetic_map_chr8_b36.txt
